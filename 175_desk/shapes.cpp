...
void MakeCylinder(unsigned int numSteps, float length, float radialFactor,  std::vector<GLfloat>* vertices,  std::vector<GLfloat>* normals)

{
    ...
    for(unsigned int i = 0; i < numSteps; i++)
    {
        ...
        t.p1.y = 0;
        t.p1.z = length;
        t.p2.x = cos(i * step)/radialFactor;
        t.p2.y = sin(i * step)/radialFactor;
        t.p2.z = length;
        t.p3.x = cos((i+1) * step)/radialFactor;
        t.p3.y = sin((i+1) * step)/radialFactor;
        t.p3.z = length;
    ...
    {
        tri t = triangles[i];
        t.p1.x = cos((i+1) * step)/radialFactor;
        t.p1.y = sin((i+1) * step)/radialFactor;
        t.p1.z = length;
        t.p2.x = cos(i * step)/radialFactor;
        t.p2.y = sin(i * step)/radialFactor;
        t.p2.z = length;
        t.p3.x = cos(i * step)/radialFactor;
        t.p3.y = sin(i * step)/radialFactor;
        t.p3.z = -length;
    ...
    for(unsigned int i = 0; i < numSteps; i++)
    {
        ...
        t.p1.y = 0;
        t.p1.z = -length;
        t.p2.x = cos((i+1) * step)/radialFactor;
        t.p2.y = sin((i+1) * step)/radialFactor;
        t.p2.z = -length;
        t.p3.x = cos(i * step)/radialFactor;
        t.p3.y = sin(i * step)/radialFactor;
        t.p3.z = -length;
    ...
    for(unsigned int i = 0; i < numSteps; i++)
    {
        ...
        tri t = triangles[i];
        t.p1.x = cos(i * step)/radialFactor;
        t.p1.y = sin(i * step)/radialFactor;
        t.p1.z = -length;
        t.p2.x = cos((i+1) * step)/radialFactor;
        t.p2.y = sin((i+1) * step)/radialFactor;
        t.p2.z = -length;
...
void MakeCones(unsigned int numSteps, float length, float radialFactor,  std::vector<GLfloat>* vertices,  std::vector<GLfloat>* normals)

{
    ...
    for(unsigned int i = 0; i < numSteps; i++)
    {
        ...
        t.p1.y = 0;
        t.p1.z = length;
        t.p2.x = cos(i * step)/(20*radialFactor);
        t.p2.y = sin(i * step)/(20*radialFactor);
        t.p2.z = length;
        t.p3.x = cos((i+1) * step)/(20*radialFactor);
        t.p3.y = sin((i+1) * step)/(20*radialFactor);
        t.p3.z = length;
    ...
    {
        tri t = triangles[i];
        t.p1.x = cos((i+1) * step)/(20*radialFactor);
        t.p1.y = sin((i+1) * step)/(20*radialFactor);
        t.p1.z = length;
        t.p2.x = cos(i * step)/(20*radialFactor);
        t.p2.y = sin(i * step)/(20*radialFactor);
        t.p2.z = length;
