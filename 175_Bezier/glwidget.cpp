...
GLWidget::GLWidget(QWidget *parent) :
  QGLWidget(parent), draw_mode(GL_TRIANGLES), angle_x(0.f), angle_y(0.f), ctrl_pt0(glm::vec3(0.5, -0.5, 0.0)), ctrl_pt1(glm::vec3(0.5, 1.0, 0.4)), ctrl_pt2(glm::vec3(0.6, 0.6, 0.0)),ctrl_pt3(glm::vec3(0.9, 0.9, 0.0)), ctrl_pt4(glm::vec3(0.9, 0.9, 0.0)), ctrl_pt5(glm::vec3(1.3, 1.5, 0.0)), ctrl_pt6(glm::vec3(1.4, 1.6, 0.0)), ctrl_pt7(glm::vec3(1.3, 1.8, 0.0)),  selected_point(0)
{
...
void GLWidget::paintGL()
{
  ...
  glUniform4f(loc_color, 0.8, 0.2, 0.8, 1.0);
...
void GLWidget::initializeBuffers()
{
 ...
 makeCubicBezierCurve(&vertices, point(ctrl_pt0.x, ctrl_pt0.y, ctrl_pt0.z), point(ctrl_pt1.x, ctrl_pt1.y, ctrl_pt1.z), point(ctrl_pt2.x, ctrl_pt2.y, ctrl_pt2.z),point(ctrl_pt3.x, ctrl_pt3.y, ctrl_pt3.z), 1);
  ...
  makeCubicBezierDisplayNormals(&vertices, point(ctrl_pt0.x, ctrl_pt0.y, ctrl_pt0.z), point(ctrl_pt1.x, ctrl_pt1.y, ctrl_pt1.z), point(ctrl_pt2.x, ctrl_pt2.y, ctrl_pt2.z),point(ctrl_pt3.x, ctrl_pt3.y, ctrl_pt3.z), 10);


  makeCubicBezierDisplayNormals(&vertices, point(ctrl_pt3.x, ctrl_pt3.y, ctrl_pt3.z), point(ctrl_pt1.x + 0.5, ctrl_pt1.y + 0.5, ctrl_pt1.z), point(ctrl_pt2.x, ctrl_pt2.y, ctrl_pt2.z),point(ctrl_pt3.x, ctrl_pt3.y, ctrl_pt3.z), 10);
